...
export const PARTY_DEFS: PartyDef[] = [
  ...
  { key: 'GRÜNE', label: 'Grüne', color: '#46962B', variants: [['GRÜNE', 'Grüne'], ['Grüne', 'Grüne'], ['BÜNDNIS 90/DIE GRÜNEN', 'Grüne'], ['Bündnis 90/Die Grünen', 'Grüne'], ['GRÜNE/B 90', 'Grüne'], ['GRÜNE/B90', 'Grüne']] },
  ...
  { key: 'FW', label: 'Freie Wähler', color: '#F29400', variants: [['FREIE WÄHLER', 'FW'], ['Freie Wähler', 'FW'], ['FW', 'FW'], ['BVB / FREIE WÄHLER', 'BVB/FW'], ['BVB/FREIE WÄHLER', 'BVB/FW']] },
