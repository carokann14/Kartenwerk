...
| `public/data/ltw-by-2023.json` | 91 Stimmkreise der Landtagswahl Bayern 2023 und daraus zusammengesetzt die 7 Wahlkreise (Regierungsbezirke) | © Bayerisches Landesamt für Statistik, Fürth 2022, Stimmkreiseinteilung zur Landtagswahl 2023 (`shapefile_stimmkreiseltw_bayern_2023.zip`) | **keine Lizenz angegeben**; Weiterverwendung nur mit diesem Copyright-Vermerk |
| `public/data/ltw-hh-2025.json` | 17 Wahlkreise der Bürgerschaftswahl Hamburg 2025 | © Statistisches Amt für Hamburg und Schleswig-Holstein, Hamburg 2025 (`Wahlkreis_BÜ2025_shape.zip`) | Verbreitung mit Quellenangabe gestattet, alle übrigen Rechte vorbehalten |
| `public/data/ltw-sl-2022.json` | 3 Wahlkreise der Landtagswahl Saarland 2022 | aus den Landkreisen der Verwaltungsgebiete 1 : 250 000 zusammengesetzt (§ 7 Landtagswahlgesetz: Saarbrücken = Regionalverband; Saarlouis = Saarlouis + Merzig-Wadern; Neunkirchen = Neunkirchen + St. Wendel + Saarpfalz-Kreis), © BKG (2026) | dl-de/by-2-0 |
| `public/data/ltw-hb-2023.json` | 2 Wahlbereiche der Bürgerschaftswahl Bremen 2023 | Städte Bremen und Bremerhaven aus den Verwaltungsgebieten 1 : 250 000, © BKG (2026) | dl-de/by-2-0 |
| `public/data/ltw-sn-2024.json` | 60 Wahlkreise der Landtagswahl Sachsen 2024 | © GeoSN (2024), Verwaltungsatlas Sachsen, Kartendienst `rest_smr_wahlen`, Ebene `landtagswahlkreise` (über den Browser abgefragt, auf 10 m vereinfacht) | dl-de/by-2-0 |
| `public/data/ltw-th-2024.json` | 44 Wahlkreise der Landtagswahl Thüringen 2024 | Landeswahlleiter Thüringen, Geo-Vektordaten zur Wahlkreiseinteilung 2024 (`16TH_L24_Wahlkreiseinteilung.zip`, GeoPackage) | **keine Lizenz angegeben** |
| `public/data/ltw-bb-2024.json` | 44 Wahlkreise der Landtagswahl Brandenburg 2024, **abgeleitet** | Gemeinden aus © BKG (2026) dl-de/by-2-0 (VG250), zugeordnet nach dem Wahlbezirksergebnis des Landeswahlleiters (`DL_BB_LT2024.xlsx`); Brandenburg an der Havel, Cottbus und Potsdam mit der groben Wahlkreiskarte der Ergebnis-Präsentation geteilt (`npm run ltw:derive -- bb`) | dl-de/by-2-0 (BKG); innere Grenzen der drei Städte genähert |

Bezug: Fundstellen je Land im Katalog `src/data/ltw.ts` (MV: https://www.laiv-mv.de/Wahlen/Landtagswahlen/2026/Wahlkreise-und-%E2%80%93leiter/, Shapefile ETRS89 / UTM 33; NRW: Gauß-Krüger Zone 2, per 7-Parameter-Helmert nach ETRS89). Aufbereitung für Kartenwerk (`npm run ltw`): nach ETRS89 / UTM 32 auf ein 10-m-Raster gebracht, auf rund 10 m vereinfacht (NRW 20 m); Namen und Nummern aus der Datei (Bayern: auf rund 30 m vereinfacht). Die Quellenzeile nennt den Vermerk und „vereinfacht“.
