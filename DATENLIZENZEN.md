...
| `public/data/ltw-ni-2022.json` | 87 Wahlkreise der Landtagswahl Niedersachsen 2022 | © Landesamt für Statistik Niedersachsen (LSN), Geometrie der Wahlkreise, Gebietsstand 01.11.2021 (`Landtagswahlkreise_Niedersachsen_2022.zip`); drei in der Datei gekürzte Namen nach wahlen.statistik.niedersachsen.de ergänzt | eigene Nutzungshinweise des LSN (noch zu prüfen) |
